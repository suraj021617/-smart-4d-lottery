...
try:
    ...
    # Add fallback for advanced routes
    def accuracy_tracker_page(): return "Advanced routes not available"
    def pair_analysis_page(): return "Advanced routes not available"
    def time_patterns_page(): return "Advanced routes not available"
    def overdue_tracker_page(): return "Advanced routes not available"
    def box_play_page(): return "Advanced routes not available"
